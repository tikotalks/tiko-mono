<template>
  <div class="video-upload-example">
    ...
    <input type="file" accept="video/*" @change="handleFileSelect" :disabled="isUploading" />
    ...
    <button v-if="selectedFile && thumbnailBlob" @click="uploadVideo" :disabled="isUploading">
...
<script setup lang="ts">
  ...
  async function uploadVideo() {
    ...
    try {
      ...
      const workerUrl =
        import.meta.env.VITE_MEDIA_UPLOAD_WORKER_URL || 'https://media-upload.tikoapi.org'
