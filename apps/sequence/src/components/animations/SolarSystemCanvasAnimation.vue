...
const planets = [
  { name: 'Sun', assetId: 'fac2efd0-d918-47ae-bbb5-a395a728707e', distance: 0, size: 400, orbitSpeed: 0, rotationSpeed: 0.0005 },
  { name: 'Mercury', assetId: '0102496e-6465-400f-8d26-9fdf3460da0c', distance: 400, size: 80, orbitSpeed: 4.74, rotationSpeed: 0.0001 },
  { name: 'Venus', assetId: '12346ef6-21ac-40f0-8254-0de41281eb27', distance: 700, size: 120, orbitSpeed: 3.5, rotationSpeed: -0.00005 }, // Venus rotates backwards
  { name: 'Earth', assetId: '14232bae-ceb6-4878-91e0-1c61ee46587c', distance: 1000, size: 130, orbitSpeed: 2.98, rotationSpeed: 0.0004 },
  { name: 'Mars', assetId: '1b0b2153-1f2e-4a1e-a984-7e436de8a81a', distance: 1500, size: 100, orbitSpeed: 2.41, rotationSpeed: 0.00038 },
  { name: 'Jupiter', assetId: '906d3fba-1f0c-470c-acbb-64f45766150b', distance: 2500, size: 300, orbitSpeed: 1.31, rotationSpeed: 0.0008 }, // Fast rotation
  { name: 'Saturn', assetId: '6dbfdb41-ab1b-4f02-bdab-9bdc9bed1a4e', distance: 3500, size: 280, orbitSpeed: 0.97, rotationSpeed: 0.0007 },
  { name: 'Uranus', assetId: '4d3ae6ed-039b-4377-b63f-20e4ab05d5f0', distance: 4500, size: 200, orbitSpeed: 0.68, rotationSpeed: -0.0003 }, // Also backwards
  { name: 'Neptune', assetId: 'b28a568d-612c-447b-8119-b98c37fe3619', distance: 5500, size: 190, orbitSpeed: 0.54, rotationSpeed: 0.0005 },
  { name: 'Pluto', assetId: '226ca7a6-f1af-49cc-b1f1-e97765c83f94', distance: 6500, size: 60, orbitSpeed: 0.47, rotationSpeed: 0.00015 }
]
  ...
  try {
    ...
    if (spaceBackgroundId) {
      try {
        ...
        console.warn('[SolarSystem] Failed to load space background video, using fallback gradient:', error)
        imagesLoaded.value++
      }
    } else {
