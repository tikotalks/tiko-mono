  ...
  <div class="reports-view">
    <div class="reports-header">
      ...
      <div class="reports-filters">
        ...
        <button @click="refreshReports" class="refresh-btn" :disabled="loading">🔄 Refresh</button>
      </div>
    </div>
...
<style>
  ...
  .app-badge[data-app='sequence'] {
    background: #e3f2fd;
    color: #1976d2;
  }
  .app-badge[data-app='cards'] {
    background: #f3e5f5;
    color: #7b1fa2;
  }
  .app-badge[data-app='timer'] {
    background: #e8f5e8;
    color: #388e3c;
  }
  .app-badge[data-app='yes-no'] {
    background: #fff3e0;
    color: #f57c00;
  }
  .app-badge[data-app='radio'] {
    background: #fce4ec;
    color: #c2185b;
  }
  .app-badge[data-app='todo'] {
    background: #e0f2f1;
    color: #00796b;
  }
  .app-badge[data-app='type'] {
    background: #f1f8e9;
    color: #558b2f;
  }
