    ...
    <form @submit.prevent="handleSubmit" :class="bemm('form')">
      ...
      <div :class="bemm('field')">
        ...
        <div v-if="form.tags.length > 0" :class="bemm('tags')">
          <span v-for="(tag, index) in form.tags" :key="`${tag}-${index}`" :class="bemm('tag')">
            {{ tag }}
            <TButton
              type="ghost"
              size="small"
      ...
      <div :class="bemm('field')">
        <label :class="bemm('checkbox-label')">
          <input type="checkbox" v-model="form.isFavorite" :class="bemm('checkbox')" />
          <TIcon
      ...
      <div :class="bemm('field')">
        ...
        <div :class="bemm('readonly-url')">
          ...
          <TButton type="ghost" size="small" icon="external-link" @click="openUrl(item.videoUrl)">
            {{ t('radio.openUrl') }}
          </TButton>
        </div>
        <p :class="bemm('help')">
      ...
      <div :class="bemm('actions')">
        ...
        <TButton color="primary" :loading="submitting" :disabled="!isFormValid || !hasChanges">
