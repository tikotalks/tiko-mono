<template>
  <div :class="bemm()">
    ...
    <div :class="bemm('content')">
      ...
      <div v-else :class="bemm('results')">
        ...
        >
          <img
            :src="
              item.customThumbnailUrl || item.thumbnailUrl || '/assets/default-radio-thumbnail.svg'
            "
            :alt="item.title"
          ...
          <div :class="bemm('result-info')">
            ...
            <div :class="bemm('result-meta')">
              <div v-if="item.tags.length > 0" :class="bemm('result-tags')">
                <span v-for="tag in item.tags.slice(0, 3)" :key="tag" :class="bemm('result-tag')">
                  {{ tag }}
                </span>
              ...
              <div :class="bemm('result-stats')">
                ...
                <span v-if="item.playCount > 0" :class="bemm('result-plays')">
                  {{ item.playCount }}
                  {{ item.playCount === 1 ? t('radio.play') : t('radio.plays') }}
                </span>
                <TIcon v-if="item.isFavorite" name="heart" :class="bemm('result-favorite')" />
              </div>
            </div>
          </div>
    ...
    <div :class="bemm('actions')">
      ...
      <TButton v-if="results.length > 0" color="primary" @click="playAll">
