<template>
  <div :class="bemm()">
    ...
    <div :class="bemm('visual')">
      ...
      <div v-if="currentItem" :class="bemm('track-info')">
        ...
        <div v-if="currentItem.tags.length > 0" :class="bemm('track-tags')">
          <span v-for="tag in currentItem.tags" :key="tag" :class="bemm('track-tag')">
            {{ tag }}
          </span>
        </div>
      </div>
      ...
      <div :class="bemm('progress-section')">
        <div :class="bemm('progress-container')">
          ...
          <div :class="bemm('progress-bar')" @click="handleProgressClick">
            <div :class="bemm('progress-track')" :style="{ width: progressPercentage + '%' }" />
            <div :class="bemm('progress-handle')" :style="{ left: progressPercentage + '%' }" />
          </div>
    ...
    <div v-if="error" :class="bemm('error')">
      ...
      <TButton type="ghost" size="small" @click="clearError" :class="bemm('error-dismiss')">
        {{ t('common.dismiss') }}
      </TButton>
    </div>
  </div>
...
<script setup lang="ts">
  ...
  const hasPrevious = computed(() => props.currentIndex > 0 || props.repeatMode === 'all')
