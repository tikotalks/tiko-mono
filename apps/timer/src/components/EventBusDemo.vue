<template>
  <div :class="bemm()">
    ...
    <div :class="bemm('buttons')">
      <TButton type="default" color="primary" @click="emitNotification" size="small">
        Emit Notification
      </TButton>

      <TButton type="default" color="success" @click="emitTimerEvent" size="small">
        Emit Timer Event
      </TButton>

      <TButton type="ghost" color="secondary" @click="clearEvents" size="small">
        Clear Events
      </TButton>
    </div>
    ...
    <div :class="bemm('events')">
      ...
      <div v-for="event in receivedEvents" :key="event.id" :class="bemm('event')">
