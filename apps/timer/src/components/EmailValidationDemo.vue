<template>
  <div :class="bemm()">
    ...
    <p :class="bemm('description')">
      The email validation should only show errors after the user has interacted with the input (touched).
      Try typing an invalid email - errors should only appear after you click outside the input or start typing.
    </p>
