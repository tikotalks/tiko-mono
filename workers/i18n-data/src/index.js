import { fetchAllTranslationData, fetchAppTranslationData, fetchActiveLanguages, fetchAllKeys, fetchAllTranslationsRaw, fetchTranslationsForLanguage } from './database';
export default {
    async fetch(request, env) {
        ...
        try {
            ...
            if (pathname === '/translations/count' && request.method === 'GET') {
                const response = await fetch(`${env.SUPABASE_URL}/rest/v1/i18n_translations?select=count`, {
                    headers: {
