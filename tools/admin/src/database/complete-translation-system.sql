...
ALTER TABLE translation_notifications ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT, INSERT, UPDATE ON translation_versions TO authenticated;
GRANT SELECT, UPDATE ON translation_notifications TO authenticated;
...
GRANT ALL ON translation_versions TO service_role;
GRANT ALL ON translation_notifications TO service_role;
...
BEGIN
    ...
    RAISE NOTICE '  ✓ languages (31 records)';
    RAISE NOTICE '  ✓ locales (62 records)';
    RAISE NOTICE '  ✓ translation_versions';
    RAISE NOTICE '  ✓ translation_notifications';
    RAISE NOTICE '';
    RAISE NOTICE 'Views created:';
    RAISE NOTICE '  ✓ translations (approved only)';
    RAISE NOTICE '  ✓ pending_translations';
    RAISE NOTICE '  ✓ translation_history';
    RAISE NOTICE '  ✓ translation_contributors';
