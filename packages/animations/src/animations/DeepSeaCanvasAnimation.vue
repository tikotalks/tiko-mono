...
const fishAssets = [
  ...
  { id: 'f989e276-16d7-43a6-a57a-638e5aff9ce1', name: 'barracuda', from: 'right', special: 'diagonal' }
]
...
const startAnimation = async () => {
  ...
  fishAssets.forEach((fish, index) => {
    ...
    setTimeout(() => {
      ...
      const endY = fish.special === 'diagonal' ? yPos + (logicalHeight * 0.3) : yPos + (Math.random() - 0.5) * 30
      ...
      canvasAnimation?.animate(fish.name, [
        {
          duration: swimSpeed,
