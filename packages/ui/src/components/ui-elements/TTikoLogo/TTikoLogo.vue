...
.logo {
  ...
  svg {
    ...
    *,
    ...
    g {
      path:nth-child(1) {
        transform: scale(0) rotate(-45deg) translateY(1em);
        animation: animI var(--time) calc(var(--delay) * 1) ease-in-out forwards;
        @keyframes animI {
          to {
      ...
      path:nth-child(2) {
        transform: scale(0) rotate(-45deg) translateY(1em);
        animation: animIDot calc(var(--delay) * 6) var(--time) ease-in-out
          forwards;
        @keyframes animIDot {
          to {
            transform: scale(1) rotate(0) translateY(0);
    ...
    > * {
      &:nth-child(1) {
        transform: scale(0) rotate(-45deg) translateX(1em);
        animation: animT var(--time) calc(var(--delay) * 0) ease-in-out forwards;
        @keyframes animT {
          to {
            transform: scale(1) rotate(0) translateX(0em);
          }
        }
      }
      ...
      &:nth-child(3) {
        transform: scale(0) rotate(45deg) translateY(1em);
        animation: animK var(--time) calc(var(--delay) * 2) ease-in-out forwards;
        @keyframes animK {
          to {
            transform: scale(1) rotate(0) translateY(0);
          }
      ...
      &:nth-child(4) {
        ...
        animation:
          animO var(--time) calc(var(--delay) * 3) ease-in-out forwards,
          rotateO calc(var(--time) * 3) calc((var(--delay) * 3) + var(--time))
            ease-in-out;
        @keyframes animO {
          to {
