...
A comprehensive user profile editing component that allows users to update their avatar, name, language preferences, and view account information. It includes avatar upload with image resizing and integration with Tiko media storage.
...
|------|------|-------------|
| `user` | `User` | Tiko identity user object |
...
- Tiko media storage integration
...
### User Metadata
Updates are stored in Tiko identity user metadata:
```javascript
{
  full_name: "John Doe",
  avatar_url: "https://...",
...
### Avatar Storage
Avatars are stored in Tiko media storage avatar area with:
