...
// Romanian translations - PARTIAL TRANSLATION
...
export const ro: TranslationSchema = {
  ...
  languageNames: {
    ...
    germanGermany: 'Germană (Germania)',
    germanAustria: 'Germană (Austria)',
    germanSwitzerland: 'Germană (Elveția)',
    englishUK: 'Engleză (Regatul Unit)',
    englishUS: 'Engleză (SUA)',
    englishAustralia: 'Engleză (Australia)',
    englishCanada: 'Engleză (Canada)',
    spanishSpain: 'Spaniolă (Spania)',
    spanishMexico: 'Spaniolă (Mexic)',
    spanishArgentina: 'Spaniolă (Argentina)',
    frenchFrance: 'Franceză (Franța)',
    frenchCanada: 'Franceză (Canada)',
    frenchBelgium: 'Franceză (Belgia)',
    dutchNetherlands: 'Olandeză (Țările de Jos)',
    dutchBelgium: 'Olandeză (Belgia)',
