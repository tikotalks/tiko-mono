...
// Irish translations - PARTIAL TRANSLATION
...
export const ga: TranslationSchema = {
  ...
  languageNames: {
    ...
    englishUK: 'Béarla (An Ríocht Aontaithe)',
    englishUS: 'Béarla (SAM)',
    englishAustralia: 'Béarla (An Astráil)',
    englishCanada: 'Béarla (Ceanada)',
    spanishSpain: 'Spáinnis (An Spáinn)',
    spanishMexico: 'Spáinnis (Meicsiceo)',
    spanishArgentina: 'Spáinnis (An Airgintín)',
    frenchFrance: 'Fraincis (An Fhrainc)',
    frenchCanada: 'Fraincis (Ceanada)',
    frenchBelgium: 'Fraincis (An Bheilg)',
    dutchNetherlands: 'Ollainnis (An Ísiltír)',
    dutchBelgium: 'Ollainnis (An Bheilg)',
    portuguesePortugal: 'Portaingéilis (An Phortaingéil)',
    portugueseBrazil: 'Portaingéilis (An Bhrasaíl)'
  },
  uiDocs: {
