...
// Croatian translations - PARTIAL TRANSLATION
...
export const hr: TranslationSchema = {
  ...
  languageNames: {
    ...
    swedish: 'Švedski',
    // Regional variants
    germanGermany: 'Njemački (Njemačka)',
    germanAustria: 'Njemački (Austrija)',
    germanSwitzerland: 'Njemački (Švicarska)',
    englishUK: 'Engleski (Ujedinjeno Kraljevstvo)',
    englishUS: 'Engleski (SAD)',
    englishAustralia: 'Engleski (Australija)',
    englishCanada: 'Engleski (Kanada)',
    spanishSpain: 'Španjolski (Španjolska)',
    spanishMexico: 'Španjolski (Meksiko)',
    spanishArgentina: 'Španjolski (Argentina)',
    frenchFrance: 'Francuski (Francuska)',
    frenchCanada: 'Francuski (Kanada)',
    frenchBelgium: 'Francuski (Belgija)',
    dutchNetherlands: 'Nizozemski (Nizozemska)',
    dutchBelgium: 'Nizozemski (Belgija)',
    portuguesePortugal: 'Portugalski (Portugal)',
    portugueseBrazil: 'Portugalski (Brazil)'
  },
    uiDocs: {
