...
// Norwegian translations - PARTIAL TRANSLATION
...
export const no: TranslationSchema = {
  ...
  languageNames: {
    ...
    germanAustria: 'Tysk (Østerrike)',
    germanSwitzerland: 'Tysk (Sveits)',
    ...
    frenchFrance: 'Fransk (Frankrike)',
    frenchCanada: 'Fransk (Canada)',
    frenchBelgium: 'Fransk (Belgia)',
    dutchNetherlands: 'Nederlandsk (Nederland)',
    dutchBelgium: 'Nederlandsk (Belgia)',
    portuguesePortugal: 'Portugisisk (Portugal)',
    portugueseBrazil: 'Portugisisk (Brasil)'
  },
    uiDocs: {
