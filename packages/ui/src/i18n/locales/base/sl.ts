...
// Slovenian translations - PARTIAL TRANSLATION
...
export const sl: TranslationSchema = {
  ...
  languageNames: {
    ...
    swedish: 'Švedščina',
    // Regional variants
    germanGermany: 'Nemščina (Nemčija)',
    germanAustria: 'Nemščina (Avstrija)',
    germanSwitzerland: 'Nemščina (Švica)',
    englishUK: 'Angleščina (Združeno kraljestvo)',
    englishUS: 'Angleščina (ZDA)',
    englishAustralia: 'Angleščina (Avstralija)',
    englishCanada: 'Angleščina (Kanada)',
    spanishSpain: 'Španščina (Španija)',
    spanishMexico: 'Španščina (Mehika)',
    spanishArgentina: 'Španščina (Argentina)',
    frenchFrance: 'Francoščina (Francija)',
    frenchCanada: 'Francoščina (Kanada)',
    frenchBelgium: 'Francoščina (Belgija)',
    dutchNetherlands: 'Nizozemščina (Nizozemska)',
    dutchBelgium: 'Nizozemščina (Belgija)',
    portuguesePortugal: 'Portugalščina (Portugalska)',
    portugueseBrazil: 'Portugalščina (Brazilija)'
  },
    uiDocs: {
