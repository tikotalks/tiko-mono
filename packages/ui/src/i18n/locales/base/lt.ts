...
// Lithuanian translations - PARTIAL TRANSLATION
...
export const lt: TranslationSchema = {
  ...
  languageNames: {
    ...
    germanGermany: 'Vokiečių (Vokietija)',
    germanAustria: 'Vokiečių (Austrija)',
    germanSwitzerland: 'Vokiečių (Šveicarija)',
    englishUK: 'Anglų (Jungtinė Karalystė)',
    englishUS: 'Anglų (JAV)',
    englishAustralia: 'Anglų (Australija)',
    englishCanada: 'Anglų (Kanada)',
    spanishSpain: 'Ispanų (Ispanija)',
    spanishMexico: 'Ispanų (Meksika)',
    spanishArgentina: 'Ispanų (Argentina)',
    frenchFrance: 'Prancūzų (Prancūzija)',
    frenchCanada: 'Prancūzų (Kanada)',
    frenchBelgium: 'Prancūzų (Belgija)',
    dutchNetherlands: 'Olandų (Nyderlandai)',
    dutchBelgium: 'Olandų (Belgija)',
    portuguesePortugal: 'Portugalų (Portugalija)',
    portugueseBrazil: 'Portugalų (Brazilija)'
  },
    uiDocs: {
