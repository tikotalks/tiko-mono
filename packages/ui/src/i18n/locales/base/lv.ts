...
// Latvian translations - PARTIAL TRANSLATION
...
export const lv: TranslationSchema = {
  ...
  languageNames: {
    ...
    germanGermany: 'Vācu (Vācija)',
    germanAustria: 'Vācu (Austrija)',
    germanSwitzerland: 'Vācu (Šveice)',
    englishUK: 'Angļu (Apvienotā Karaliste)',
    englishUS: 'Angļu (ASV)',
    englishAustralia: 'Angļu (Austrālija)',
    englishCanada: 'Angļu (Kanāda)',
    spanishSpain: 'Spāņu (Spānija)',
    spanishMexico: 'Spāņu (Meksika)',
    spanishArgentina: 'Spāņu (Argentīna)',
    frenchFrance: 'Franču (Francija)',
    frenchCanada: 'Franču (Kanāda)',
    frenchBelgium: 'Franču (Beļģija)',
    dutchNetherlands: 'Holandiešu (Nīderlande)',
    dutchBelgium: 'Holandiešu (Beļģija)',
    portuguesePortugal: 'Portugāļu (Portugāle)',
    portugueseBrazil: 'Portugāļu (Brazīlija)'
  },
    uiDocs: {
